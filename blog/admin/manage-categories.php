...
<section class="dashboard">
    ...
    <?php if(isset($_SESSION['add-category-success'])) : // shows if add user was successful ?>
    ...
    <?php elseif(isset($_SESSION['add-category'])) : // shows if add user was NOT successful ?>
